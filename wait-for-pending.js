...
async function waitForPendingTransactions() {
  try {
    ...
    console.log('💡 Check transactions at: https://evm-testnet.flowscan.io/address/' + account.address);
    console.log('');
    ...
    if (hasPending) {
      ...
      console.log(`   https://evm-testnet.flowscan.io/address/${account.address}`);
    }
  } catch (error) {
