...
export default function App({ thirdwebClient }: AppProps) {
    ...
    try {
      ...
      notifySuccess('License Minted', 
        `Successfully minted license!\nTransaction: ${result.data.txHash}`,
        {
          action: {
            label: 'View Transaction',
            onClick: () => window.open(`https://evm-testnet.flowscan.io/tx/${result.data.txHash}`, '_blank')
          }
        }
      );
      } else {
  ...
  const payRevenue = async () => {
    ...
    try {
      ...
      if (royaltyBreakdown) {
        const breakdownText = [
          `Total: ${royaltyBreakdown.totalAmount} FLOW`,
          `Platform Fee: ${royaltyBreakdown.platformFee.toFixed(6)} FLOW (2.5%)`,
          ...royaltyBreakdown.licenseRoyalties.map(
            lr => `License ${lr.licenseId}: ${lr.amount.toFixed(6)} FLOW (${lr.royaltyPercentage}%)`
          ),
          `IP Owner: ${royaltyBreakdown.ipOwnerShare.toFixed(6)} FLOW`,
        ].join('\n');
      ...
      // Show success notification
      notifySuccess('Payment Successful', `Successfully paid ${paymentAmount} FLOW in revenue!`);
  ...
  const claimRoyalties = async () => {
    ...
    try {
      ...
      notifySuccess('Royalties Claimed', `Successfully claimed ${formatEther(claimedAmount)} FLOW!`);
  ...
  const unstakeArbitrator = async () => {
    ...
    try {
      ...
      notifyInfo('Unstaking Arbitrator', `Withdrawing ${formatEther(stake)} FLOW stake...`);
      ...
      notifySuccess('Stake Withdrawn', `Successfully withdrew ${formatEther(stake)} FLOW! You are no longer an active arbitrator.`);
      await loadArbitrationData();
    } catch (error: any) {
      ...
      <div className="app">
        ...
        <main className="landing">
          <div className="landing-hero">
            ...
            <div className="landing-badge">IP on-chain • Flow EVM • ERC-6551</div>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <span style={{ color: '#1e293b' }}>{royaltyBreakdown.totalAmount} FLOW</span>
                  </div>
                  ...
                  <div style={{
                    ...
                    <span style={{ color: '#1e293b' }}>{royaltyBreakdown.platformFee.toFixed(6)} FLOW</span>
                  </div>
                  ...
                  <div style={{
                    ...
                    <span style={{ color: '#1e293b' }}>{royaltyBreakdown.remainingAfterFee.toFixed(6)} FLOW</span>
                  </div>
                  ...
                  <div style={{
                    ...
                    <span style={{ color: '#1e293b' }}>{royaltyBreakdown.ipOwnerShare.toFixed(6)} FLOW</span>
                  </div>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <span style={{
                      ...
                      {formatEther(accumulatedRoyalties.get(claimTokenId) || 0n)} FLOW
                    </span>
                  </div>
                      ...
                      if (isUserArbitrator && userIsActive && userStake > 0n) {
                        return (
                          <>
                            <div className="form-group" style={{ gridColumn: '1 / -1' }}>
                              <div style={{
                                ...
                                <div style={{ marginTop: '0.5rem' }}>
                                  <div>💰 Stake: {formatEther(userStake)} FLOW</div>
                            ...
                            >
                              {loading ? '⏳ Unstaking...' : `💸 Unstake (${formatEther(userStake)} FLOW)`}
                            </button>
                          </>
                        );
                      } else {
                        return (
                          <>
                    <div className="form-group">
                      <label className="form-label">💰 Minimum Stake (FLOW)</label>
                      <input
                        type="number"
                        className="form-input"
                            ...
                            return (
                              ...
                              >
                                ...
                                <div style={{ fontSize: '0.85rem', color: 'var(--color-text-secondary)' }}>
                                  ...
                                  <div>💰 Stake: {formatEther(arb.stake)} FLOW</div>
                                </div>
                              </div>
                            );
                          })}
                          ...
                          <div key={addr} className="card">
                            ...
                            <div className="card-body">
                              ...
                              <div className="card-field">
                                ...
                                <span className="card-field-value">💰 {formatEther(arb.stake)} FLOW</span>
                              </div>
                              <div className="card-field">
                  ...
                  <div className="card-body">
                    ...
                    <div className="card-field">
                      ...
                      <span className="card-field-value" style={{ 
                        ...
                        💰 {parseFloat(formatEther(asset.totalRevenue)).toFixed(6)} FLOW
                      </span>
                    </div>
