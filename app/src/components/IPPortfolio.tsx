      ...
      <div className="portfolio-header">
        ...
        <div className="portfolio-stats">
          ...
          <div className="stat-card">
            <div className="stat-icon">💰</div>
            <div className="stat-content">
              <div className="stat-value">{formatEther(totalRevenue)} FLOW</div>
                  ...
                  {userAssets.slice(0, 3).map(([id, asset]) => (
                    <div key={id} className="recent-asset">
                      ...
                      <div className="recent-asset-info">
                        ...
                        <div className="asset-revenue">{formatEther(asset.totalRevenue)} FLOW</div>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="performance-metrics">
                  <div className="metric">
                    ...
                    <span className="metric-value">
                      {totalAssets > 0 ? formatEther(totalRevenue / BigInt(totalAssets)) : '0'} FLOW
                    </span>
                  </div>
                  <div className="metric">
                ...
                >
                  ...
                  <div className="asset-info">
                    ...
                    <div className="asset-metrics">
                      <div className="metric">
                        <span>💰 Revenue</span>
                        <span>{formatEther(asset.totalRevenue)} FLOW</span>
                      </div>
                      <div className="metric">
                        <span>🎯 Royalty</span>
                ...
                <div key={portfolio.id} className="portfolio-card">
                  ...
                  <div className="portfolio-metrics">
                    <div className="metric">
                      ...
                      <span>{formatEther(portfolio.totalValue)} FLOW</span>
                    </div>
                    <div className="metric">
                      <span>📅 Created</span>
                ...
                <div className="revenue-chart">
                  {userAssets.map(([id, asset]) => (
                    <div key={id} className="revenue-bar">
                      ...
                      <div className="bar-value">{formatEther(asset.totalRevenue)} FLOW</div>
                    </div>
                  ))}
                </div>
              </div>
