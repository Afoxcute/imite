...
[![Flow](https://img.shields.io/badge/Flow-000000?style=flat&logo=ethereum&logoColor=white)](https://flow.com/)
...
- **Confidential contract**: `contracts/ConfidentialIPAsset.sol` stores encrypted metadata and optional confidential revenue; deployable on Flow EVM or other EVM chains.
...
- **Encryption Support**: Optional content protection (client-side AES-GCM encryption of metadata; optional ConfidentialIPAsset deployment for confidential storage)
...
- **Flow Team**: For blockchain infrastructure support
