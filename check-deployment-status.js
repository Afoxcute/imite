...
async function checkDeploymentStatus() {
  try {
    ...
    console.log('💡 Explorer: https://evm-testnet.flowscan.io/address/' + account.address);
    console.log('');
    ...
    if (pendingNonce > confirmedNonce) {
      ...
      console.log('   2. Check explorer: https://evm-testnet.flowscan.io/address/' + account.address);
